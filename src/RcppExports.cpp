...
// rcpp_trainHmmVb
S4 rcpp_trainHmmVb(NumericMatrix dataTranspose, const RObject& VbStructure, const List& searchControl, const List& trainControl, IntegerVector nthread, Function VB, Function HMM, Function HMMVB);
RcppExport SEXP _HDclust_rcpp_trainHmmVb(SEXP dataTransposeSEXP, SEXP VbStructureSEXP, SEXP searchControlSEXP, SEXP trainControlSEXP, SEXP nthreadSEXP, SEXP VBSEXP, SEXP HMMSEXP, SEXP HMMVBSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type dataTranspose(dataTransposeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_trainHmmVb(dataTranspose, VbStructure, searchControl, trainControl, nthread, VB, HMM, HMMVB));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_HDclust_rcpp_trainHmmVb", (DL_FUNC) &_HDclust_rcpp_trainHmmVb, 8},
    {NULL, NULL, 0}
};
